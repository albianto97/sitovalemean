...
export class OrderDetailsComponent implements OnInit {
  ...
  initializeOrderDetails(): void {
    ...
    this.productService.getProductsById(productIds).subscribe((products: Product[]) => {
    ...
    this.userService.getSingleUserById(this.order.user).subscribe((userData: any) => {
      this.user = userData;
    });
  }
  ...
  sendNotification(): void {
    ...
    this.userService.getSingleUserById(this.order.user).subscribe((userData: any) => {
      if (userData) {
        ...
        this.notificationService.createNotify(username, notifyDate.toISOString(), this.order._id, false, message, "").subscribe((notification: Notify) => {
